...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_anomaly_alerts_id"), "anomaly_alerts", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_anomaly_alerts_sensor_id"),
        "anomaly_alerts",
        ["sensor_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_tasks_equipment_id"),
        "maintenance_tasks",
        ["equipment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_maintenance_tasks_id"), "maintenance_tasks", ["id"], unique=False
    )
    op.create_table(
        "sensor_readings",
        ...
        sa.Column(
            "sensor_metadata", postgresql.JSONB(astext_type=Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        'ix_sensor_readings_sensor_id_timestamp_desc',
        'sensor_readings',
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_sensor_readings_sensor_id_timestamp_desc', table_name='sensor_readings')
    ...
    op.drop_index(
        op.f("ix_maintenance_tasks_equipment_id"), table_name="maintenance_tasks"
    )
